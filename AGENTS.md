...
This file provides guidance to AI coding agents (Claude Code, Codex, Copilot, Gemini, etc.) when working with code in this repository.
...
**Access**: Ask questions via the Deepwiki MCP server if your agent has it configured (in Claude Code: `mcp__deepwiki__ask_question`), or browse https://deepwiki.com directly.
